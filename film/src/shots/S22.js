...
module.exports = {
  ...
  frame(ctx, t, s, env) {
    ...
    const sp = L.at(cam, 2.2, walkZ - 1.3); L.drawChar(ctx, W, H, (c, st) => S.draw(c, { gait: 'trot', phase: dt * 2.2, stride: 0.7, t: dt, mouth: 'pant', tail: 1, headYaw: 0.3 }, st), { x: sp.x, y: sp.y, scale: sp.scale, flip: true }, { light });
